...
const CATEGORIES: Record<string, string> = { CONTENT_QUALITY: "基础内容校对", COMPLIANCE: "合规", BRAND: "品牌", PRODUCT_ACCURACY: "产品准确性", CAMPAIGN_EFFECTIVENESS: "传播有效性", ADVERTISING: "广告表达", CLAIM: "宣传主张" };
